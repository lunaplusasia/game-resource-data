...
- **⚔️ [Fighter (นักรบ)](#fighter-นักรบ)** — Avg 85.4 🟡
  - [Human Fighter](#human-fighter)
    ...
    - [1151 พาลาดิน](#1151-paladin) **C5** `86` 🟡
  ...
  - [Elf Fighter](#elf-fighter)
    ...
    - [1251 พาลาดิน](#1251-paladin) **C5** `86` 🟡
...
- **🗡️ [Rogue (โจร/นักธนู)](#rogue-โจร/นักธนู)** — Avg 82.0 🟡
  - [Human Rogue](#human-rogue)
    ...
    - [2154 Arch Breezer](#2154-arch-breezer) **C5** `83` 🟡
  ...
  - [Elf Rogue](#elf-rogue)
    ...
    - [2254 Arch Breezer](#2254-arch-breezer) **C5** `83` 🟡
    - [2255 Magnus](#2255-magnus) **C5** `79` 🔴
- **🔮 [Mage (จอมเวท)](#mage-จอมเวท)** — Avg 81.2 🟡
  - [Human Mage](#human-mage)
    ...
    - [3154 เนโครแมนเซอร์](#3154-necromancer) **C5** `65` 🔴
  ...
  - [Elf Mage](#elf-mage)
    ...
    - [3254 เนโครแมนเซอร์](#3254-necromancer) **C5** `65` 🔴
...
> **Avg Rating:** 85.4/100 · **C5 Jobs:** 11 · เน้นการต่อสู้ระยะประชิดด้วยดาบและโล่ พลังทำลายสูง มี CC และบัฟสนับสนุน
>
> DMG `98` · AoE `83` · CC `82` · Utility `85` · Survivability `75`
...
> 🟡 **Overall: 85.8**/100 · DMG `98` · AoE `100` · CC `100` · Util `75` · Surv `56`
...
> **Avg Rating:** 82.0/100 · **C5 Jobs:** 10 · เน้นความเร็วและการโจมตีระยะไกลด้วยธนู หรือระยะประชิดแบบลอบเร้น
>
> DMG `99` · AoE `86` · CC `79` · Utility `76` · Survivability `65`
...
> 🟡 **Overall: 83.4**/100 · DMG `100` · AoE `78` · CC `96` · Util `74` · Surv `64`
...
| 3 | 🔧 ปรับ | Utility | ✨ ปรับค่า fStatusDataMul สกิลบัฟ (×1.3-1.5) | `Skill_Buff_List.bin.txt` | 1.0 |
...
> 🟡 **Overall: 83.2**/100 · DMG `100` · AoE `95` · CC `69` · Util `75` · Surv `70`
...
| # | ประเภท | มิติ | รายละเอียด | ไฟล์ที่แก้ | Gap |
|---|--------|------|----------|------------|-----|
| 1 | ➕ เพิ่ม | CC | 🔒 เพิ่มสกิล CC อีก 1 ตัว (มี 2) | `Skill_Get_List / Skill_Buff_List` | 6.2 |
...
> **Avg Rating:** 81.2/100 · **C5 Jobs:** 10 · เน้นเวทมนตร์โจมตี ฮีล บัฟ และ CC ระยะไกล มีทั้งสายโจมตีและสายซัพพอร์ต
>
> DMG `96` · AoE `94` · CC `76` · Utility `80` · Survivability `57`
...
> 🔴 **Overall: 64.6**/100 · DMG `100` · AoE `95` · CC `0` · Util `87` · Surv `33`
...
| 2 | 🔧 ปรับ | Survivability | 🛡️ ปรับค่า fStatusDataMul สกิลบัฟ/ฮีล (×1.3-1.5) | `Skill_Buff_List.bin.txt` | 32.0 |
